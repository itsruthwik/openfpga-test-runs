...
//	parameter WEIGHTS_INIT_FILE = "home/advent2/quartus_projects/mlp_controller_v2/rf_weights.mif"
)(
	input  clk,
	input  rst,
	// Rx interface
...
for (dpe_id = 0; dpe_id < DPES; dpe_id = dpe_id + 1) begin: generate_datapath
	memory_block # (
		...
		.DEPTH(RFDEPTH),
		.ADDRW(RFADDRW)
		 //"/home/advent2/quartus_projects/mlp_controller_v2/rf_weights.mif"
	) rf (
		.clk(clk),
		.rst(rst),
		.waddr(rf_waddr),
