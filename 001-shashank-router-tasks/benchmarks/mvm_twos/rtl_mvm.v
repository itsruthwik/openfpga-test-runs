...
// genvar dpe_id;
// generate 
// for (dpe_id = 0; dpe_id < 4; dpe_id = dpe_id + 1) begin: generate_datapath
// 	memory_block # (
// 		.DATAW(DATAW),
// 		.DEPTH(RFDEPTH),
// 		.ADDRW(RFADDRW),
// 		// .INIT_FILE (WEIGHTS_INIT_FILE) //"/home/advent2/quartus_projects/mlp_controller_v2/rf_weights.mif"
// 		.WEIGHTS_INIT_SEL (WEIGHTS_INIT_SEL) 
// 	) rf (
// 		.clk(clk),
// 		.rst(rst),
// 		.waddr(rf_waddr),
